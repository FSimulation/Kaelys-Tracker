    ...
    def handle(self, data: dict):
        ...
        if data["jobDelivered"] and not data["onJob"]:
            ...
            job_data = {
                ...
                "truck_license_plate": data["truckLicensePlate"],
                "trailer_global": f'{str(data["trailer"][2]["bodyType"]).capitalize()} {str(data["trailer"][2]["chainType"]).capitalize()}',
                "trailer_license_plate": data["trailer"][2]["licensePlate"],
