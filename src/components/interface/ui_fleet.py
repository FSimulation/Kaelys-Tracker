...
class Fleet(ctk.CTkFrame):
    ...
    def setup_ui(self):
        ...
        ets2_path = tools.resource_path("src/static/truckimg.png")
        ats_path = tools.resource_path("src/static/truckimg.png")
        ...
        self.ets2_panel = self._build_game_panel(self, "ETS2", 0, self.ets2_image)
        self.ats_panel = self._build_game_panel(self, "ATS", 1, self.ats_image)
    ...
    def _add_info_row(self, container, row, label_text, value_text):
        ...
        value.grid(row=row, column=1, sticky="e", padx=(10, 15), pady=4)
